#ifndef __EVA_BEAM_PROBLEM__
#define __EVA_BEAM_PROBLEM__
...
class beam_problem : public pagmo::problem::base
{
public:

    template <typename GetA, typename GetI>
    struct geometry
    {
        real length;
        real height;

        inline real get_A() { return GetA(); }
        inline real get_I() { return GetI(); }
    };
// public:
